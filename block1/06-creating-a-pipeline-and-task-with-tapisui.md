...
<image alt="Login" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/01-login.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/02-navbar.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/03-click-create-group.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/04-create-group.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/05-navigate-to-pipeline.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/06-click-create-pipeline.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/07-create-pipeline.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/08-edit-pipeline.png" style="width: 400px">

On this page, click the `+ New Task` button, this will generate a modal with a dropdown containing task types

<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/09-click-add-task.png" style="width: 400px">

Choose the `image_build` option and click the `Next >` button

<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/10-select-image-build.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/11-select-builder.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/12-github-context.png" style="width: 400px">

In the `Visibility and Credentials` section of the context, select the `public` option

<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/13-context-visibility.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/14-destination.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/15-task-created.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/16-run-pipeline.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/17-view-runs.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/18-view-task-executions.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/19-task-executions.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/20-new-task.png" style="width: 400px">

Select a the `tapis_job` option from the task type drop down and click the `Next >` button.

<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/21-select-tapis-job.png" style="width: 400px">

Add an `id` and `description`

<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/22-fields.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/23-add-deps.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/24-job-def-and-create.png" style="width: 400px">

Navigate back to the pipeline page and add another `tapis_job` task for the uniaxial traction benchmark.

<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/25-fields.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/26-deps.png" style="width: 400px">
...
<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/27-job-def.png" style="width: 400px">

Now that all of our tasks have been created, we can submit the complete pipeline for processing.

<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/28-view-tasks.png" style="width: 400px">

Click the `Run Pipeline` button to trigger the modal, then submit the pipeline.

<image alt="tutorial-image" src="https://github.com/tapis-project/workflows-tutorial/tree/main/block1/images/29-final-run.png" style="width: 400px">
